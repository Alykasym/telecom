...
export const unitTemplates = {
    ...
    'hmg_team': { name: 'Heavy Machine Gun Team', category: UNIT_CATEGORIES.INFANTRY, armor: ARMOR_CLASSES.UNARMORED, weapon: WEAPON_TYPES.HEAVY_MG, range: 1200, detection: 1500, mobility: 2, ammo: 500, icon: '🔫', precision: 0.6 },
    ...
    'manpads_team': { name: 'MANPADS Team', category: UNIT_CATEGORIES.INFANTRY, armor: ARMOR_CLASSES.UNARMORED, weapon: WEAPON_TYPES.ANTI_AIR, range: 4000, detection: 5000, mobility: 3, ammo: 6, icon: '🌤️', precision: 0.7 },

    // Vehicles
    'recon_jeep': { name: 'Reconnaissance Jeep', category: UNIT_CATEGORIES.VEHICLE, armor: ARMOR_CLASSES.UNARMORED, weapon: WEAPON_TYPES.HEAVY_MG, range: 800, detection: 4000, mobility: 25, ammo: 200, icon: '🚙', precision: 0.4 },
    'apc': { name: 'Armored Personnel Carrier', category: UNIT_CATEGORIES.VEHICLE, armor: ARMOR_CLASSES.LIGHT, weapon: WEAPON_TYPES.HEAVY_MG, range: 1000, detection: 1500, mobility: 18, ammo: 1000, icon: '🚐', precision: 0.4 },
    ...
    'aa_vehicle': { name: 'Self-Propelled AA', category: UNIT_CATEGORIES.VEHICLE, armor: ARMOR_CLASSES.LIGHT, weapon: WEAPON_TYPES.ANTI_AIR, range: 6000, detection: 8000, mobility: 12, ammo: 100, icon: '📡', precision: 0.6 },
    ...
    'interceptor_jet': { name: 'Interceptor Jet', category: UNIT_CATEGORIES.AIRCRAFT, armor: ARMOR_CLASSES.UNARMORED, weapon: WEAPON_TYPES.ANTI_AIR, range: 15000, detection: 20000, mobility: 200, ammo: 6, icon: '🦅', precision: 0.8 },
